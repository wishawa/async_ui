...
- [Preparations](./preparations/README.md)
	- [Prerequisites](./preparations/1-background.md)
	- [Installation](./preparations/2-installation.md)
...
- [Modifying the UI](./dynamicity/README.md)
	- [Using the JS API](./dynamicity/1-using-js-api.md)
